...
// .panel-box/.stat-grid(battle.css) 재사용
import './battle.css'
import './campaign.css'
    ...
    <div className="campaign-screen">
      <header className="campaign-header">
        ...
        <span
          ...
          title={`인수(印綬) — 전투 중 도구 메뉴에서 써서 부대를 상위 병과로 승급시킨다 (Lv${PROMOTION_LEVEL} 이상)`}
        >
          인수 {seals}
        </span>
        ...
        <section className="panel-box unit-detail">
          {selected && selOfficer && selClass ? (
            <>
              ...
              {/* v0.9: 승급은 전투 중 도구 메뉴에서 인수를 써서 한다 (원작 방식) */}
              <p className="promote-hint">
                인수는 전투 중 도구 메뉴에서 사용한다 (Lv{PROMOTION_LEVEL} 이상)
              </p>
